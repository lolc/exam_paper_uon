...
\newcommand{\subjectname}{Digital and Computer Electronics 2} % subject name
\newcommand{\quiznumber}{1} % quiz number
\newcommand{\modulecode}{ELEC3730} % subject code
\newcommand{\school}{School of Engineering} % school
\newcommand{\totalqn}{NINE~(9)} % total number of questions
...
\newcommand\myskip{\bigskip \bigskip}
